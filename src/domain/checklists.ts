...
const minutaFields: ChecklistField[] = [
  ...
  field("property.registration", "Dados do imóvel", "Matrícula", true, "MINUTA", "identificador_imovel"),
...
const itbiFields: ChecklistField[] = [
  ...
  field("property.registration", "Dados do imóvel", "Matrícula", true, "ITBI", "identificador_imovel"),
...
const sourceMap: Record<string, DocumentSource[]> = {
  ...
  "property.type": ["SIOPI", "MINUTA", "ITBI", "FRACOES", "CADASTRO_EMPREENDIMENTO"],
  ...
  "property.commonArea": ["SIOPI", "MINUTA", "ITBI", "CADASTRO_EMPREENDIMENTO"],
