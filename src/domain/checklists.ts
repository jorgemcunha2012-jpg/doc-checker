...
const sourceMap: Record<string, DocumentSource[]> = {
  ...
  "property.development": ["SIOPI", "MINUTA", "ITBI", "DADOS_RESERVA"],
  "property.registration": ["SIOPI", "MINUTA", "ITBI", "DADOS_RESERVA"],
  "property.iptu": ["SIOPI", "MINUTA", "ITBI"],
  "property.address": ["SIOPI", "MINUTA", "ITBI"],
  "property.unit": ["SIOPI", "MINUTA", "ITBI", "DADOS_RESERVA"],
  "property.tower": ["SIOPI", "MINUTA", "ITBI", "DADOS_RESERVA"],
